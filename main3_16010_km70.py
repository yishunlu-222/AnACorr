...
if __name__ == "__main__":
    ...
    refl_filaname = '16010_ompk_10_3p5keV_km70_AUTOMATIC_DEFAULT_SAD_SWEEP1.refl.json'
    refl_filaname = 'scaled_km70.refl.json'
    expt_filaname = '16010_ompk_10_3p5keV_km70_AUTOMATIC_DEFAULT_SAD_SWEEP1.expt.json'   # only contain axes
    save_dir = './save_data/{}_best_km70_{}_{}_(okp)v_nor_scaled'.format(dataset,args.expri,args.angle)
...
#    print('the offset angle is {}'.format(offset))
    ...
    for i, row in enumerate(select_data):
        ...
        rotation_matrix_frame_2 = np.array([[1, 0, 0],
                                          [0, np.cos(rotation_frame_angle), -np.sin(rotation_frame_angle)],
                                          [0, np.sin(rotation_frame_angle), np.cos(rotation_frame_angle)]])                                          
