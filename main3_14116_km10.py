...
if __name__ == "__main__":
    ...
    label_list = np.load('./14116_tomobar_cropped.npy').astype(np.int8)
    refl_filaname = '14116_ompk_19_3keV_km10_AUTOMATIC_DEFAULT_SAD_SWEEP1.refl.json'
    expt_filaname = '14116_ompk_19_3keV_km10_AUTOMATIC_DEFAULT_SAD_SWEEP1.expt.json'   # only contain axes
    save_dir = './save_data/{}_best_km10_{}_{}_okpv_combor'.format(dataset,args.expri,args.angle)
...
#        rotation_matrix_frame = np.dot(F, rotation_matrix_frame_1)
#        rotation_matrix_frame = np.dot(F,rotation_matrix_frame_1)
