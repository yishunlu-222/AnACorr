...
if __name__ == "__main__":
    ...
    refl_filaname = '16010_ompk_10_3p5keV_km70_pm120_AUTOMATIC_DEFAULT_SAD_SWEEP1.refl.json'
    refl_filaname = 'scaled_km70_pm120.refl.json'
    expt_filaname = '16010_ompk_10_3p5keV_km70_pm120_AUTOMATIC_DEFAULT_SAD_SWEEP1.expt.json'   # only contain axes
    save_dir = './save_data/{}_best_km70_pm120_{}_{}_(okp)v_nor_scaled'.format(dataset,args.expri,args.angle)
