...
if __name__ == "__main__":
    ...
    save_dir = './save_data/{}_scaled_ac_{}_{}_{}_{}_{}'.format( dataset,args.proportion,args.cr,args.li,args.lo,args.bu )
    try:
    ...
    npy_list = []
#    mu_cr = 0.01892e3 * (1 + propt*args.cr) # (unit in mm-1) 16010
#    mu_li = 0.01812e3 * (1 + propt*args.li)
#    mu_lo = 0.0162e3 * (1 + propt*args.lo)
#    mu_bu = 0.0399e3 * (1 + propt*args.bu)
