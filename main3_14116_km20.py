...
if __name__ == "__main__":
    ...
    refl_filaname = '14116_ompk_19_3keV_km20_AUTOMATIC_DEFAULT_SAD_SWEEP1.refl.json'
    expt_filaname = '14116_ompk_19_3keV_km20_AUTOMATIC_DEFAULT_SAD_SWEEP1.expt.json'   # only contain axes
    save_dir = './save_data/{}_best_km20_{}_{}_okpv_combor'.format(dataset,args.expri,args.angle)
